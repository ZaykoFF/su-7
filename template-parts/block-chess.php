...
<div class="chess">
    ...
    <div class="chess-bottom<? if ($slug == 'kommunar' or $slug == 'dinastia') echo ' chess-bottom-kommunar'; ?>" <? if ($slug == 'kommunar' or $slug == 'dinastia') echo 'style="background-image:url(/wp-content/themes/su-7/img/house_min.svg);"'; ?>>
