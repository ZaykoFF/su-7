...
<complexes>
    <complex>
        <id>122579</id>
        <name>ЖК "Коммунар"</name>
        <latitude>57.787167</latitude>
        <longitude>40.916249</longitude>
        <address>г. Кострома, ул. Ткачей, д.5</address>
        <images>
            <image>
                <?php echo get_site_url(); ?>/wp-content/uploads/2024/10/1-1.jpg
            </image>
        </images>
        <profits_main>
            <profit_main>
